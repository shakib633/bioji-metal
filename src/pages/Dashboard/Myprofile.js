        ...
        <section className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1'>
            <div class="card w-96 bg-base-100 shadow-xl ml-1">
                <div class="card-body">
                    ...
                    <p><span className='font-bold'>Name:</span> {update[0]?.name}</p>
                    <p><span className='font-bold'>Email:</span> {update[0]?.email}</p>
            ...
            <div>
                <form className='flex flex-col items-center' onSubmit={handleUpdateInfo}>
                    ...
                    <input className='btn btn-outline w-2/4' type="submit" value="Update Profile" />
                </form>
            </div>
        </section>
    );
