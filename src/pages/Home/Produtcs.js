  ...
  return (
    <section>
      <div className="card w-fit bg-base-100 shadow-xl mb-16 mt-16">
        <figure>
          <img style={{ width: "200px" }} src={picture} alt="parts" />
        </figure>
        <div className="card-body text-left">
          ...
          <p>
            <span className="font-bold">Available Quantity:</span> {total}
          </p>
          <p>
            <span className="font-bold">Minimum Order Quantity:</span> {minimum}
          </p>
          <p>
            <span className="font-bold">Price:</span> ${price} (per unit)
          </p>
